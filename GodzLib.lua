local Configs_HUB = {
  Cor_Hub = Color3.fromRGB(19, 19, 19),
  Cor_Options = Color3.fromRGB(19, 19, 19),
...
function MakeNotifi(Configs)
  local Title = Configs.Title or "Godz Library"
  ...
  local Frame2 = Create("Frame", Frame1, {
    Size = UDim2.new(0, Menu_Notifi.Size.X.Offset - 60, 0, 0),
  ...
  task.spawn(function()
    CreateTween(FrameSize, "Size", UDim2.new(0, 3, 0, 2), timewait, true)
  end)
  
  TextButton.MouseButton1Click:Connect(function()
    CreateTween(Frame2, "Position", UDim2.new(0, -20, 0, 9), 1.1, true)
    CreateTween(Frame2, "Position", UDim2.new(0, Menu_Notifi.Size.X.Offset, 0, 0), 0.5, true)
    Frame1:Destroy()
  end)
  
  task.spawn(function()
    CreateTween(Frame2, "Position", UDim2.new(0, -30, 0, 2), 0.5, true)
    CreateTween(Frame2, "Position", UDim2.new(), 0.1, true)task.wait(timewait)
    if Frame2 then
      CreateTween(Frame2, "Position", UDim2.new(0, -20, 3, 6), 0.1, true)
      CreateTween(Frame2, "Position", UDim2.new(0, Menu_Notifi.Size.X.Offset, 0, 0), 0.5, true)
      Frame1:Destroy()
    end
  end)
...
function MakeWindow(Configs)
  ...
  local Anim_Title = Configs.Hub.Animation or "by : Godz"
